                        ...
                        ?>
                                <form action="" method="POST">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="#"><img src="assets/images/pro3/<?= $fetch_cart['image'] ?>" alt=""></a>
                                            </td>
                                            <td><a href="#">cotton shirt</a>
                                                <div class="mobile-cart-content row">
                                                    ...
                                                    <div class="col">
                                                        <h2 class="td-color">$<?= $fetch_cart['price'] ?></h2>
                                                    </div>
                                                    <div class="col">
                                            ...
                                            <td>
                                                <h2>$<?= $fetch_cart['price'] ?></h2>
                                            </td>
                                            <td>
                                                <div class="qty-box">
                                                    <div class="input-group">
                                                        <input type="number" name="quantity" class="form-control input-number" value=<?= $fetch_cart['quantity'] ?>>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h2 class="td-color">$<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></h2>
                                            </td>
                                            <td><a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="btn btn-secondary">Delete</a></td>
