            ...
            <div class="row">
                <div class="col">
                    <div class="product-4 product-m no-arrow">
                        <?php
                        $select_products = $conn->prepare("SELECT * FROM `product` LIMIT 5");
                        ...
                        ?>
                                <form action="" method="POST" class="product-box">
                                    ...
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).php"><img src="assets/images/pro3/<?= $fetch_products['image'] ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).php"><img src="assets/images/pro3/<?= $fetch_products['image'] ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        ...
                                        <input type="hidden" min="1" value="1" name="p_qty" class="qty">
                                        <div class="cart-info cart-wrap">
                                            <?php if(!isset($_SESSION['user_id'])){ ?>
                                            <a href="login.php" ><i class="ti-shopping-cart"></i></a>
                                            <?php }else {?>
                                            <button name="add_to_cart"><i class="ti-shopping-cart"></i></button>
                                            <?php }?>
                    ...
                    <div class="theme-tab">
                        ...
                        <div class="tab-content-cls">
                            ...
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider row">
                                    <?php
                                    $select_products = $conn->prepare("SELECT * FROM `product` LIMIT 8");
                                    $select_products->execute();
                                    if ($select_products->rowCount() > 0) {
                                        while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                    ...
                                    <!-- <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).php"><img
